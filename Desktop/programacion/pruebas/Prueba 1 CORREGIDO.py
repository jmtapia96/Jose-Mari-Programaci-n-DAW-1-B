...
1.1
"""
while player_1!= "tijeras" and player_1!= "spock" and player_1!="lagarto" and player_1!="papel" and player_1!="piedra":
        player_1= input("Jugador 1, haga su elección. ")
while player_2!= "tijeras" and player_2!= "spock" and player_2!="lagarto" and player_2!="papel" and player_2!="piedra":
...
"""
SE CAMBIA EL elif POR EL else YA QUE NO ES NECESARIO COMPROBAR LA SEGUNDA POSIBILIDAD
"""  
elif player_1== ("papel"):
